...
public class ListExample { // this is the main body of the whole class
	...
	public static void main(String[] args) { //the main method of the whole class
		...
		boolean value = true; //if the enterd password and user name is true this method will execute
		String in ="";
	...
	public static void cdDetails() { // this method is about the adding CDs into the menu
										// the data base
		String confirm ="yes";
	...
	public static void deleteCd() { // This method is about deleting CD from the
		...
		String confirm;
		do {
			System.out.println("Do you want to Delete another CD? (Yes/No)");
			confirm = sc.next();
			if (!(confirm.equalsIgnoreCase("yes") || confirm.equalsIgnoreCase("no")))
				System.out.println("Invalid input. Enter (Yes/No)");
		} while (!(confirm.equalsIgnoreCase("yes") || confirm.equalsIgnoreCase("no")));
	...
	public static void rentCd() { // This method about rent a CD from the database
		int y = 0;
		System.out.println(" ");
		System.out.println("\t\t +-+-+ +-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+-+-+"+"\n"+
	...
	public static void searchCd() { //This method about searching a cd from the database
			...
			System.out.println("");
			do {
			System.out.print("Enter CD number that you want search: ");
			int itemNumber = sc.nextInt();
			System.out.println("");
	...
	public static void editCd(){ //this method about editing a CDs in the database
		System.out.println("");
		System.out.println("\t\t +-+-+-+-+ +-+-+ +-+-+-+-+-+-+-+"+"\n"+
		...
		String confirm;
		do {
			System.out.println("Do you want to Search another CD? (Yes/No)");
			confirm = sc.next();
			if (!(confirm.equalsIgnoreCase("yes") || confirm.equalsIgnoreCase("no")))
				System.out.println("Invalid input. Enter yes/no");
		} while (!(confirm.equalsIgnoreCase("yes") || confirm.equalsIgnoreCase("no")));
	...
	public static void dueDates(){ //This method about show a reminder about rented CDs in the database
		int count=0;
		System.out.println(" ");
		System.out.println("\t\t +-+-+-+-+-+-+-+-+-+"+"\n"+
		"\t\t |R|e|m|i|n|d|e|r|s|" + '\n'+
